...
def render_analytics_tab():
    ...
    tsne_path = "chart/champion_embeddings_tsne.png"
...
with st.sidebar:
    ...
    app_mode = option_menu(
        ...
        options=["Draft Simulator", "Analytics"],
        
        # 1. BỎ ICON: Truyền list rỗng tương ứng với số lượng option
        icons=['', ''], 
        
        menu_icon="cast", # Icon tiêu đề (giữ lại cho đẹp, hoặc xóa dòng này nếu muốn bỏ nốt)
        default_index=0,
        
        styles={
            # 2. CONTAINER: Nền màu tối (Dark Gray/Black)
            "container": {
                "padding": "5!important", 
                "background-color": "#1E1E1E" 
            },
            
            # 3. ITEM CHƯA CHỌN: Chữ màu trắng
            "nav-link": {
                "font-size": "18px",
                "text-align": "left",
                "margin": "0px",
                "color": "#FFFFFF",      # <--- Chữ trắng
                "--hover-color": "#333333" # <--- Hover màu xám nhẹ
            },
            
            # 4. ITEM ĐÃ CHỌN: Nền xanh, Chữ đậm
            "nav-link-selected": {
