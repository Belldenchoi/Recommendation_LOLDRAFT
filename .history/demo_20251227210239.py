...
def render_analytics_tab():
    ...
    with st.container(border=True):
        ...
        with col1:
            if os.path.exists("team-winrate.png"):
                st.image("team-winrate.png", caption="Tỷ lệ thắng giữa hai đội", use_container_width=True)
            else: st.warning("Thiếu ảnh team-winrate.png")
            
        with col2:
            if os.path.exists("game-duration.png"):
                st.image("game-duration.png", caption="Phân bố thời gian trận đấu", use_container_width=True)
    ...
    with st.container(border=True):
        ...
        with col3:
            if os.path.exists("most-use-champ.png"):
                st.image("most-use-champ.png", caption="WordCloud: Tướng được dùng nhiều nhất", use_container_width=True)
